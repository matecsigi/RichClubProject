...
g_low <-read.graph("5000_50_3_12.gml", format="gml")
...
g_medium <-read.graph("5000_50_3_30.gml", format="gml")
...
g_high <-read.graph("5000_50_3_100.gml", format="gml")
...
legend("topright",inset=0.04, legend=c("T=100","T=20","T=12"),lty=c(1,1,1),pch=c(24,21,22),col=c("black","black","black"),pt.bg=c("red","green","blue"),bty="n",cex=2.6,pt.cex=3,lw=5)
